class EndbossBar extends DrawableObject {
    ENDBOSS_IMAGES = [
        ...
        'img/7_statusbars/2_statusbar_endboss/statusbar_endboss0.png',          // 4    
    ...
    setBosshealth(bosshealth) {                                  // abgesenen von dieser Variablen müssen wir noch herausfinden, welches dieser Bilder dafür nehmen
        this.percentage = bosshealth;                            // => aus dieser Prozentzahl müssen wir nun eine Zahl zwischne 0... und 5 ermitteln, weil wir 5 Bilder haben. Mit folgender if Abfrage.
